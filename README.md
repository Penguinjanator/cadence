...
| **Changing memory**<br>[Web demo](https://floatingpragma.io/cadence-examples/memory/)<br>[Code](https://github.com/muellerberndt/cadence-examples/tree/main/memory) | One write stores an association and a later write replaces it. Compare with an MLP on the same stream. | 12 neurons, 32 synapses, 32 persistent + 32 transient weights |
