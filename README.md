...
|---|---|---|
| **Eye & arm**<br>[Web demo](https://floatingpragma.io/cadence-examples/eye-arm/)<br>[Code](https://github.com/muellerberndt/cadence-examples/tree/main/eye-arm) | A retina reads your drawing, and shoulder, elbow and pencil motors copy it. Push a joint or disable a motor population. | 593 neurons, 28 synapses |
| **Teachable mouse**<br>[Web demo](https://floatingpragma.io/cadence-examples/mouse/)<br>[Code](https://github.com/muellerberndt/cadence-examples/tree/main/mouse) | Teach it a new destination, revise the lesson, and carry it into a new maze. | 265 neurons, 285 synapses, 32 learned |
...
| **Fly-inspired forager**<br>[Web demo](https://floatingpragma.io/cadence-examples/fly/)<br>[Code](https://github.com/muellerberndt/cadence-examples/tree/main/fly) | Learns nectar values on contact and changes its preferences when you change the flowers. | 18 neurons, 44 synapses, 32 learned |
| **Changing memory**<br>[Web demo](https://floatingpragma.io/cadence-examples/memory/)<br>[Code](https://github.com/muellerberndt/cadence-examples/tree/main/memory) | One write stores an association and a later write replaces it. Compare with an MLP on the same stream. | 12 neurons, 32 synapses, 32 learned |
